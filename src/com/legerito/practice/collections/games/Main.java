package com.legerito.practice.collections.games;

import com.legerito.practice.collections.games.Card;
...
public class Main {
    ...
    public static void printFewData() {
        ...
        Card.printDeck(deck.subList(32, 36), "Replaced 10 hearts with 10 clubs", 1);
